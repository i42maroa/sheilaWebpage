...
export default function CaperucitaPage ({ setPageBook }) {
    return (   
        <Pages
            leftPage={
                <>
                    <div className={bookStyles.layoutSingleColumn}>
                        ...
                        <div className={bookStyles.layoutButton}>
                            <BackButton className={bookStyles.buttonContainer} setPageBook={setPageBook} page={INDEX_PAGE.SECOND_PAGE}/>
                ...
                <>
                    ...
                    <div className={bookStyles.layoutSingleColumn}>
                        ...
                        <div className={bookStyles.layoutButton}>
                            ...
                            <NextButton className={bookStyles.buttonContainer} setPageBook={setPageBook} page={INDEX_PAGE.CaperucitaPage  + 1} />                          
                        </div>                   
                    </div>
                </>
            }
